                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="{{ route('peminjaman.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor Transaksi</label></div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="tanggal_transaksi"
                                            placeholder="Masukkan Tanggal Peminjaman" class="form-control"><small
                                            class="form-text text-muted"></small></div>
                                </div>
