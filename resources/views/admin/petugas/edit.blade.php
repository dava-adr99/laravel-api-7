                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="{{ route('petugas.update', $data->id) }}" method="post"
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">nama_petugas
                                        </label></div>

                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_petugas"
                                            value="{{ $data->username }}" placeholder="Masukkan nama petugas"
                                            class="form-control"><small class="form-text text-muted"></small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input"
                                            class=" form-control-label">kode_petugas</label></div>

                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="kode_petugas"
                                            value="{{ $data->address }}" placeholder="Masukkan kode petugas"
                                            class="form-control"><small class="form-text text-muted"></small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input"
                                            class=" form-control-label">jenis_kelamin</label></div>

                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="jenis_kelamin"
                                            value="{{ $data->address }}" placeholder="Masukkan jenis kelamin"
                                            class="form-control"><small class="form-text text-muted"></small></div>
                                </div>
