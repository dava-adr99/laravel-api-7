                            ...
                            <form action="{{ route('buku.update', $data->id) }}" method="post"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="judul_buku"
                                            value="{{ $data->judul_buku }}" placeholder="Masukkan judul buku"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_pengarang"
                                            value="{{ $data->nama_pengarang }}" placeholder="Masukkan nama pengarang"
                                            class="form-control"><small class="form-text text-muted"></small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input"
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="tahun_terbit"
                                            value="{{ $data->tahun_terbit }}" placeholder="Masukkan tahun terbit"
                                            class="form-control"><small class="form-text text-muted"></small></div>
                                </div>
                                <div>
