                            ...
                            <form action="{{ route('buku.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="judul_buku"
                                            placeholder="Masukkan judul buku" class="form-control"><small
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="nama_pengarang"
                                            placeholder="Masukkan nama pengarang" class="form-control"><small
                                            class="form-text text-muted"></small></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input"
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="tahun_terbit"
                                            placeholder="Masukkan tahun terbit" class="form-control"><small
                                            class="form-text text-muted"></small></div>
                                </div>
